...
public class MarketFSMBehaviourAuctionProgress extends FSMBehaviour {
	/**
	 * The AID of the seller agent who created the auction which is managed by
	 * this behaviour.
	 */
	private final AID mySeller;

	/**
	 * The ID of the conversation associated with the auction that this
	 * behaviour manages.
	 */
	...
	/**
	 * Create the behaviour of a market agent which is responsible for enforcing
	...
	/**
	 * 
	 * @return the AID of the seller agent who created the auction which is
	 *         managed by this behaviour.
	 */
	...
	/**
	 * 
	 * @return the AID of the bidder to which the fish supply has been
	 *         attributed, null if not attribution.
	 */
	...
	/**
	 * 
	 * @param selectedBidder
	 *            the AID of the bidder to which the fish supply has been
	 *            attributed, null meaning no attribution.
	 */
	...
	/**
	 * 
	 * @return the <code>AID</code> of the first bidder for the current price if
	 *         there has been, <code>null</code> otherwise.
	 */
	...
	/**
	 * 
	 * @return the list of bidders for the last received
	 *         <code>to_announce</code>.
	 */
	 ...
	 * 
	 * @param bidder
	 *            the <code>AID</code> of a bidder agent which is to be added to
	 *            the list od bidder for the last received
	 *            <code>to_announce</code>.
	 */
	...
	/**
	 * Creates a unique conversation id based on the AID of the seller agent
	 * which initiated and auction.
	 * 
	 * @param sellerAID
	 *            AID of the seller agent which initiated and auction.
	 * 
	...
	/**
	 * 
	 * @return base message filter for conversations for the auction managed by
	 *         this behaviour.
	 */
	...
	private class WaitToBidMarketBehaviour extends OneShotBehaviour {
		...
		private MessageTemplate createMessageFilter() {
			return MessageTemplate.and(this.myFSM.getMessageFilter(),
					MessageTemplate.or(MessageTemplate.MatchPerformative(FishMarketProtocol.Performatives.TO_BID),
							MessageTemplate.or(MessageTemplate.MatchPerformative(FishMarketProtocol.Performatives.TO_ANNOUNCE),
